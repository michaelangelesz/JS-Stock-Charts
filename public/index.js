...
/** adding the calculateAverage function breaks the whole page. When I console.log using mockData (commenting out my fetch request) the stocks show in the console just fine. My API is fresh. So since twelvedata only allows 8 fetches per min, and this page shows three charts that use 4 stocks each will make 12 fetches. hence breaking the code */